...
- 이슈 확인 : gh cli 도구를 이용해 Issue 내용과 docs/2-product-requirements-document.md, docs/7-execution-plan.md 문서를 읽어와 적절한 서브에이전트를 이용해 분석한다.
...
- 테스트 수행 : 적합한 서브에이전트들을 사용하여 미리 작성한 테스트를 이용해 테스팅한다.
