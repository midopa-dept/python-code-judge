  ...
  public: {
    Tables: {
      ...
      education_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "education_sessions_creator_id_fkey"
            columns: ["creator_id"]
            isOneToOne: false
      ...
      scoreboards: {
        ...
        Relationships: [
          {
            foreignKeyName: "scoreboards_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "education_sessions"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "scoreboards_student_id_fkey"
            columns: ["student_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      session_problems: {
        ...
        Relationships: [
          {
            foreignKeyName: "session_problems_problem_id_fkey"
            columns: ["problem_id"]
            isOneToOne: false
